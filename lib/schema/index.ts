...
export const QuestionSchema = z.object({
  ...
  stemImageUrl: z.string().nullable().optional(),
  stemImageAlt: z.string().nullable().optional().default(''),
  choices: z.array(z.string().min(1, 'Choice cannot be empty')).min(2, 'At least 2 choices are required').max(6, 'At most 6 choices are allowed'),
  answer: AnswerSchema,
