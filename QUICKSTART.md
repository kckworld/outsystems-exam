...
2. 파일 업로드 또는 JSON 붙여넣기 모드를 선택
3. `data/` 폴더의 JSON 파일을 선택하거나 JSON을 직접 붙여넣기
4. 같은 title/description으로 이어서 올릴 경우 merge 옵션 활성화
5. "Import" 클릭
6. 문제 세트가 준비 완료!
...
`.env` 파일 내용:
```bash
ADMIN_PASSWORD=your-production-admin-password-here
# 선택: 기존 하위 호환
